...
from RuLSIF import RuLSIF, SEP
from helpers import to_numpy_matrix


def densratio(x, y, method="RuLSIF", alpha=0, sigma_range="auto", lambda_range="auto", kernel_num=100, verbose=False):
    ...
    if method == "SEP":
        ...
        return RuLSIF(x, y, alpha, sigma_range, lambda_range, kernel_num, verbose)
