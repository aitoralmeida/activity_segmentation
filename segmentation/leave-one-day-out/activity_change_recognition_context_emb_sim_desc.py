...
def main(argv):
    ...
    for train_indexes, test_index in train_test_indexes:
        ...
        # calculate optimum min dist and context window length with training data
        best_min_dist_global = 0
        ...
        for context_window_size in [1, 2, 3, 4, 5]:
            ...
            for min_dist in min_dists:
                cf_matrix_1 =  get_conf_matrix_with_offset_strategy_desc(similarities_train, y_train, timestamps_train, min_dist, 1)
            ...
            if best_G_MEAN > best_G_MEAN_global:
                ...
                best_min_dist_global = best_min_dist
        ...
        print("Calculated optimum min dist: " + str(best_min_dist_global))
        ...
        cf_matrix_1 = get_conf_matrix_with_offset_strategy_desc(similarities_test, y_test, timestamps_test, best_min_dist_global, 1)
        TN, FP, FN, TP = cf_matrix_1.ravel()
        TPR = TP/(TP+FN)
        TNR = TN/(TN+FP)
        FPR = FP/(FP+TN)
        ...
        cf_matrix_5 = get_conf_matrix_with_offset_strategy_desc(similarities_test, y_test, timestamps_test, best_min_dist_global, 5)
        ...
        cf_matrix_10 = get_conf_matrix_with_offset_strategy_desc(similarities_test, y_test, timestamps_test, best_min_dist_global, 10)
